...
txtfile = ""
today = date.today()
rose = "© Blake Gouthro | Rosewell OS V1.3.7 | Rosewell Software | Nov. 9th 2021 - " + str(today.year) + " | Today's Date = " + str(today) + " ©"
while True:
    print(rose)
...
#Basic
        if todo == "Basic" or todo == "basic" or todo == "Code" or todo == "code":
            print("© Blake Gouthro and JinHo Mo | Rosewell BASIC Demo | V1.3 | Rosewell Software | 2021 - " + str(today.year))
