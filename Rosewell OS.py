...
txtfile = ""
today = date.today()
rose = "© Blake Gouthro | Rosewell OS V1.4 | Rosewell Software | Nov. 9th 2021 - " + str(today.year) + " | Today's Date = " + str(today) + " ©"
while True:
    print(rose)
        ...
        if todo == "Basic" or todo == "basic" or todo == "BASIC" or todo == "Code" or todo == "code":
            ...
            def Go(num):
                ...
                for i in range(num):
                    exec(save)
            def allchr():
                print('abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890' + u"\u2680" + u"\u2681" + u"\u2682" + u"\u2683" + u"\u2684" + u"\u2685" + u"\u2688" + "@&# !" + '"' + "$%'()*+,-./:;>=<?\[]{}^_" + u"\u0060" + "|~" + u"\u00A1" + u"\u00A2" + u"\u00A3" + u"\u00A4" + u"\u00A5" + u"\u00A6" + u"\u00A7" + u"\u00A8" + u"\u00A9" + u"\u00AA" + u"\u00AB" + u"\u00AC" + u"\u00AE" + u"\u00AF" + u"\u00B0" + u"\u00B6" + u"\u00BB" + u"\u00BC" + u"\u00BD" + u"\u00BE" + u"\u00BF" + u"\u00D7" + u"\u00F7" + u"\u2580" + u"\u2581" + u"\u2582" + u"\u2583" + u"\u2584" + u"\u2585" + u"\u2586" + u"\u2587" + u"\u2588" + u"\u2589" + u"\u258A" + u"\u258B" + u"\u258C" + u"\u258D" + u"\u258E" + u"\u258F" + u"\u2590" + u"\u2591" + u"\u2592" + u"\u2593" + u"\u2594" + u"\u2595" + u"\u2596" + u"\u2597" + u"\u2598" + u"\u2599" + u"\u259A" + u"\u259B" + u"\u259C" + u"\u259D" + u"\u259E" + u"\u259F")
            def repeatchr(num):
                for i in range(num):
                    atsciiprint()
                print(' ')
            ...
            def poke(word):
                ...
                try:
                    ...
                    print(e) 
            rosex = "© Blake Gouthro and JinHo Mo | Rosewell BASIC DEMO| V1.4.5 | Rosewell Software | 2021 - " + str(today.year) + " ©"
            ...
            while True:
              ...
              while True:
                  ...
                  #Load 8
                  if line == 'Load,8' or line == 'load,8' or line == 'l8' or line == 'L8' or line == 'Load*8' or line == 'load*8':
                    programs = '/Volumes/'
                    print(" ")
                    ...
                    load8s = input("Enter rogram Name including the extension. [ex.'.ext'. type 'Exit to return to Ready Prompt]: " )
